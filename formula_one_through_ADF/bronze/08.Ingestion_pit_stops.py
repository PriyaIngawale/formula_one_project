...
# MAGIC %run ../bronze/cmn_fun

# COMMAND ----------

pit_stop_df =spark.read.json('/mnt/sagen2databricks/f1-project/bronze/pitstops/',recursiveFileLookup=True)
...
pit_stops_df1.write.option('format','delta').mode('overwrite').save('/mnt/sagen2databricks/f1-project/silver/pit_stops')

# COMMAND ----------

spark.read.load('/mnt/sagen2databricks/f1-project/silver/pit_stops')