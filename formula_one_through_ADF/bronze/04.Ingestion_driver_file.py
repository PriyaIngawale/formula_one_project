...
df = spark.read.option('multiline',True).json('/mnt/sagen2databricks/f1-project/bronze/drivers/',recursiveFileLookup=True)
df.display()
...
df.write.option('format','delta').mode('overwrite').save('/mnt/sagen2databricks/f1-project/silver/drivers')