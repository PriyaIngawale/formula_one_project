...
qualifying_df = spark.read.json('/mnt/sagen2databricks/f1-project/bronze/qualifying/',recursiveFileLookup=True)
...
qualifying_df1.write.option('format','delta').mode('overwrite').save('/mnt/sagen2databricks/f1-project/silver/qualifying')